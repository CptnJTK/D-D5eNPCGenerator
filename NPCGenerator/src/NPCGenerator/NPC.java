...
public class NPC {
    ...
    private final String[] MANNERISMS = { "singing quietly to themself", "whistling to themself",
            ...
            "cracking knuckles" };
    private final String[] INTERACTIONS = { "argumentative", "arrogant", "blustering", "rude",
            "curious", "friendly", "honest", "hot tempered", "irritable", "ponderous", "quiet",
            "suspicious" };
    ...
    public String[] generateOutput() throws IOException {
        ...
        String info = name + " is " + indefiniteArticle + " " + gender[0] + " " + race
                ...
                + talent + " and has a habit of " + mannerism + ". " + name + " typically acts "
